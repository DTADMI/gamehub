...
const nextConfig: NextConfig = {
  ...
  transpilePackages: [
    ...
    "@projects/story-forge",
    "@projects/quest-hunt",
    "@projects/libra-keeper",
    "@projects/velvet-galaxy",
    "@react-three/fiber",
    "@react-three/drei",
    "three",
    "axios",
  ...
  webpack: (config, { isServer }) => {
    ...
    const projectsPath = path.resolve(__dirname, "../../packages/projects");
    ...
    config.resolve.alias = {
      ...
      // Projects
      "@projects/story-forge": path.resolve(projectsPath, "story-forge"),
      "@projects/quest-hunt": path.resolve(projectsPath, "quest-hunt"),
      "@projects/libra-keeper": path.resolve(projectsPath, "libra-keeper"),
      "@projects/velvet-galaxy": path.resolve(projectsPath, "velvet-galaxy"),
