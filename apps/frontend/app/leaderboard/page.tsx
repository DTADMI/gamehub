...
export default function LeaderboardPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {SCOPES.map((s) => {
            ...
            return (
              <button
                key={s}
                className={`rounded px-2 py-1 text-sm ${scope === s ? "bg-primary text-primary-foreground" : "bg-muted text-foreground/80"} ${disabled ? "cursor-not-allowed opacity-60" : ""}`}
        ...
        <div className="flex items-center gap-2">
          ...
          {WINDOWS.map((w) => {
            ...
            return (
              <button
                key={w}
                className={`rounded px-2 py-1 text-sm ${window_ === w ? "bg-primary text-primary-foreground" : "bg-muted text-foreground/80"} ${disabled ? "cursor-not-allowed opacity-60" : ""}`}
      ...
      {loading && <div className="py-8 text-center">Loading leaderboard...</div>}
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              {entries.map((row) => {
                ...
                return (
                  ...
                  >
                    <td className="text-muted-foreground px-6 py-3 text-sm">{row.rank}</td>
