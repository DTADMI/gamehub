          ...
          <TabsContent value="users">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage user access to specific projects.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex h-32 items-center justify-center rounded-md border-2 border-dashed">
                  <p className="text-muted-foreground italic">
                    User List & Permission Matrix Placeholder
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="flags">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Toggle major application features.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-muted-foreground text-sm">Allow new users to sign up.</p>
                    </div>
                    <Switch
                      checked={flags["user-registration-open"]}
                  ...
                  <div className="flex items-center justify-between rounded-lg border p-4 opacity-50">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Disable frontend for non-admins.
                      </p>
                    </div>
