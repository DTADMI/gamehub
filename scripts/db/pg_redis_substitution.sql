...
CREATE TABLE IF NOT EXISTS leaderboard_scores (leaderboard_key TEXT NOT NULL, user_id TEXT NOT NULL, score DOUBLE PRECISION NOT NULL DEFAULT 0, updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), PRIMARY KEY (leaderboard_key, user_id));
CREATE INDEX IF NOT EXISTS idx_leaderboard_rank ON leaderboard_scores (leaderboard_key, score DESC);
