...
import { GameContainer, soundManager, submitScore } from "@/lib/game-platform";
...
export const SnakeGame: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("snake:pauseToggle", onPauseToggleAction as EventListener);
    return () => {
      window.removeEventListener("snake:restart", onRestartAction as EventListener);
      window.removeEventListener("snake:pauseToggle", onPauseToggleAction as EventListener);
    };
  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <div className="mb-3 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          ...
          <div className="inline-flex overflow-hidden rounded-md border border-gray-300 dark:border-gray-700">
            <button
              ...
              className={`min-h-11 px-4 py-2 text-sm ${controlScheme === "swipe" ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"}`}
            >
              Swipe
            </button>
            <button
              ...
              className={`min-h-11 border-l border-gray-300 px-4 py-2 text-sm dark:border-gray-700 ${controlScheme === "joystick" ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"}`}
            >
              Joystick
            </button>
            <button
              ...
              className={`min-h-11 border-l border-gray-300 px-4 py-2 text-sm dark:border-gray-700 ${controlScheme === "taps" ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"}`}
            >
              Taps
            </button>
          </div>
        ...
        <div className="mb-4 flex flex-wrap justify-center gap-2">
          {(["classic", "obstacles", "portal", "speed"] as GameMode[]).map((mode) => (
            <button
              ...
              className={`min-h-11 rounded-md px-4 py-2 ${
                config.mode === mode
        ...
        {pendingMode && (
          <div className="bg-card text-card-foreground mx-auto mb-4 max-w-md rounded-md border p-3 shadow-sm">
            <p className="mb-2 text-sm">
              Restart the game in <b>{pendingMode}</b> mode? Current progress will be lost.
            </p>
            <div className="flex justify-end gap-2">
              <button
                className="text-secondary-foreground bg-secondary hover:bg-secondary/80 min-h-11 rounded-md px-4 py-2 text-sm"
                onClick={() => {
                  setPendingMode(null);
                  setIsPaused(false);
                }}
              ...
              <button
                className="text-primary-foreground bg-primary hover:bg-primary/90 min-h-11 rounded-md px-4 py-2 text-sm"
                onClick={() => {
        ...
        {(!gameStarted || isPaused) && !gameOver && (
          <button
            ...
            className="mx-auto mt-3 flex h-16 w-full max-w-xl items-center justify-center rounded-md bg-black/40 text-base font-semibold text-white select-none sm:text-lg"
            onClick={() => {
              if (!gameStarted) {
                setGameStarted(true);
              } else {
        ...
        {/* Controls Info */}
        <div className="mt-4 text-center text-base text-gray-600 sm:text-sm dark:text-gray-400">
  ...
  return (
    <div className="select-none">
      <div
        ...
        className="relative h-32 w-32 rounded-full bg-gray-200 shadow-inner dark:bg-gray-700"
        style={{ touchAction: "none" }}
      >
        <div
          ref={knobRef}
          className={`absolute top-1/2 left-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-md ${
