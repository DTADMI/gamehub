...
import { soundManager } from "@/lib/game-platform";
          ...
          row.map((sq, c) => {
            ...
            return (
              <button
                ...
                data-r={r}
                data-c={c}
                className={`flex h-12 w-12 items-center justify-center border text-sm select-none ${
                  dark ? "bg-muted/60 text-foreground" : "bg-card text-card-foreground"
                } ${isSel ? "outline-accent outline outline-2" : ""}`}
