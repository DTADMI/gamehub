  ...
  switch (icon) {
    case 'pen':
      return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
          <path
            d="M 14.5 3.5 L 5.5 12.5 L 4 16 L 7.5 14.5 L 16.5 5.5 Z"
            stroke="currentColor"
            strokeWidth="1.5"
            fill="none"
          />
    ...
    case 'hand':
      return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
          <path
            d="M 5 16 V 10 Q 5 6 8 5 Q 12 4 12 8 V 16"
            stroke="currentColor"
            strokeWidth="1.5"
            fill="none"
          />
...
export function ToolPalette({ currentTool, onSelectTool }: ToolPaletteProps) {
  ...
  return (
    <div className="flex flex-col gap-1 p-2">
      <span className="text-xs font-medium px-1 mb-1" style={{ color: 'var(--gw-text-muted)' }}>
      ...
      {TOOLS.map((tool) => (
        <button
          ...
          style={{
            backgroundColor: currentTool === tool.id ? 'var(--gw-accent-purple)' : 'transparent',
            color: currentTool === tool.id ? '#fff' : 'var(--gw-text-secondary)',
          }}
