...
export const projectsManifest: ProjectMetadata[] = [
  {
    ...
    fullDescription: 'A comprehensive library management system that helps you track your books, manage lending to friends, and keep your collection organized. Features include barcode scanning, lending tracking, and collection analytics.',
...

  {
    ...
    fullDescription: 'Create, participate in, and share location-based treasure hunts. Discover hidden gems in your city, create quests for friends, and explore the world around you in a new way.',
    category: 'social',
...

  {
    ...
    fullDescription: 'A powerful tool for writers and storytellers to create, collaborate, and organize their narratives. Features branching storylines, character management, and world-building tools.',
    category: 'creative',
