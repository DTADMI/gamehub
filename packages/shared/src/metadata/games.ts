...
export const games: GameManifest = {
    ...
    "rite-of-discovery": {
        ...
        shortDescription:
            "Gentle point‑and‑click about family‑made magic (Alpha MVP).",
    ...
    "systems-discovery": {
        ...
        shortDescription:
            "Explore everyday systems with extendable packs (Alpha MVP).",
        tags: ["Adventure", "Point & Click", "Educational"],
        image: "https://picsum.photos/seed/systems-discovery/1280/1280",
        enabled: true,
        visible: true,
        backgroundImage:
            "https://picsum.photos/seed/bg-systems-discovery/1280/1280",
        preloadAssets: [],
        getComponent: () =>
            // @ts-ignore
    ...
    "chrono-shift": {
        ...
        shortDescription:
            "Manipulate time and space to navigate shifting environments.",
    ...
    "elemental-conflux": {
        ...
        shortDescription:
            "Control multiple characters with complementary elemental abilities.",
