    ...
    <section className="mx-auto max-w-5xl px-4 py-8">
      ...
      {!paymentsEnabled && (
        <div className="border-warning/30 bg-warning/10 mb-4 rounded-md border p-3 text-sm">
          Payments are coming soon. You can explore tiers below; subscription checkout is disabled
          in this build.
        </div>
      )}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Collaboration, advanced permissions, shared resources, team analytics.
            </CardDescription>
          </CardHeader>
          <CardContent>
