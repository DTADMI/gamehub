...
export default async function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="border-fg/10 mt-12 border-t pt-10">
        <h2 className="text-lg font-bold">Project Settings</h2>
        <form action={updateSettings.bind(null, project.id)} className="mt-4 grid max-w-xl gap-4">
          <div>
          ...
          <div>
            <button className="bg-brand hover:bg-brand/90 rounded-md px-4 py-2 text-white transition-colors">
              Save Settings
            </button>
          </div>
        </form>
