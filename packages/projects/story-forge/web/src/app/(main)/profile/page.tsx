    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <button className="bg-brand rounded-md px-4 py-2 text-white">Save</button>
          {pot?.balance != null && (
      ...
      >
        ...
        <div>
          ...
          <select
            name="cadence"
            defaultValue={(user?.settings?.preferences?.cadence as string) ?? "daily"}
            className="border-fg/20 mt-1 w-full rounded-md border px-3 py-2 text-sm"
          >
          ...
          <div className="mt-2 flex flex-col gap-2 text-sm">
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="breakReminders"
                defaultChecked={Boolean(user?.settings?.preferences?.breakReminders)}
              />{" "}
          ...
          <div className="mt-2 flex items-center gap-4 text-sm">
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="ch_email"
                defaultChecked={Boolean(user?.settings?.preferences?.channels?.email)}
              />{" "}
              Email
            </label>
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="ch_sms"
                defaultChecked={Boolean(user?.settings?.preferences?.channels?.sms)}
              />{" "}
              SMS
            </label>
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="ch_push"
                defaultChecked={Boolean(user?.settings?.preferences?.channels?.push)}
              />{" "}
              Push
            </label>
          </div>
        ...
        <div className="flex items-center justify-end">
          <button className="bg-brand rounded-md px-4 py-2 text-white">Save Preferences</button>
        </div>
      </form>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <button className="bg-brand rounded-md px-4 py-2 text-white">Save Goal</button>
          <span className="text-sm">
