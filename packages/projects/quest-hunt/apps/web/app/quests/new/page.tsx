...
export default function CreateQuestPage() {
  ...
  const handleWaypointChange = (id: string, field: string, value: any) => {
    const waypoints = form
      .getValues('waypoints')
      .map((wp) => (wp.id === id ? { ...wp, [field]: value } : wp));
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium">
                    Waypoints ({form.getValues('waypoints').length})
                  </h3>
                      ...
                      {form.getValues('waypoints').map((waypoint, index) => (
                        <div key={waypoint.id} className="border rounded-lg p-4 space-y-3">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleWaypointChange(waypoint.id, 'title', e.target.value)
                            }
                          />
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              handleWaypointChange(waypoint.id, 'description', e.target.value)
                            }
                            className="min-h-[100px]"
                          />

                          <div className="text-sm text-muted-foreground">
                            Location: {waypoint.latitude.toFixed(4)},{' '}
