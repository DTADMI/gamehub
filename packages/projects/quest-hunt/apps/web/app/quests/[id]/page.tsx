...
import {Card, CardContent, CardDescription, CardHeader, CardTitle} from '@games/shared/components/ui/card';
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        <Badge variant="outline"
                                                               className={statusColors[waypoint.status]}>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span
                                                            className="text-muted-foreground text-sm">2 weeks ago</span>
                                                    </div>
                                                    ...
                                                    <p className="mt-1">
                                                        ...
                                                        locations were beautiful. Definitely recommend to anyone looking
                                                        for an
                                                        adventure.
                                                    </p>
                                                </div>
